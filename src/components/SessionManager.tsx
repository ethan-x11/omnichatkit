  ...
  const innerContent = (
    <div 
      className={cn(
        ...
        !isPopoutCollapsible && (variant === 'inline-drawer' ? "w-[280px]" : "w-[260px]"),
        className,
        isPopoutCollapsible && "w-full"
      )} 
      style={style}
    >
  ...
  if (variant === 'drawer') {
    ...
    return (
      <Drawer open={isOpen} onOpenChange={setIsOpen} modal={false} swipeDirection={swipeDirection}>
        ...
        <DrawerContent
          className={cn(
            !className?.includes('w-') ? "w-[300px] sm:w-[400px]" : "",
            "p-0",
            className
          )}
        >
      ...
      <SheetPrimitive.Portal>
        <SheetPrimitive.Popup
          ...
          className={cn(
            ...
            "data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:h-full data-[side=left]:border-r data-[side=left]:data-ending-style:translate-x-[-2.5rem] data-[side=left]:data-starting-style:translate-x-[-2.5rem]",
            "data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-full data-[side=right]:border-l data-[side=right]:data-ending-style:translate-x-[2.5rem] data-[side=right]:data-starting-style:translate-x-[2.5rem]",
            !className?.includes('w-') ? "data-[side=left]:w-3/4 data-[side=right]:w-3/4 data-[side=left]:sm:max-w-sm data-[side=right]:sm:max-w-sm w-[300px] sm:w-[400px]" : "",
            "p-0",
            className
          )}
        >
